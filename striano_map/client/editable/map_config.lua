...
local function SmoothMoveMapCamTo(targetPos, duration) -- CAMBIATA E FATTO CHE ORA TI METTE DIRETTAMENTE IL CHECKPOINT!
	...
	exports.striano_map:blipInteresse(vector3(targetPos.x, targetPos.y, targetPos.z), "#FFD800")
...
function openMapManager()
	...
	exports['striano_fastmenu']:addMenuItem("[ Your Position ]", function() 
		exports.striano_map:blipInteresse(vector3(myPos.x, myPos.y, myPos.z))
		PlaySoundFrontend(-1,'Bomb_Disarmed','GTAO_Speed_Convoy_Soundset',0)
		ExecuteCommand("prova3 Waypoint added.")
	end, false) 
	exports['striano_fastmenu']:addMenuItem("[ Clear All Waypoints ]", function() 
		exports.striano_fastmenu:close() exports.striano_combat:showZone("", "Waypoints cleared.") exports.striano_map:delblipInteresse() 
	end, false) 
	...
	if exports['striano_core']:getCoordMission() ~= nil then -- diverso ~
		exports['striano_fastmenu']:addMenuItem("[ MAIN QUEST POS ]", function() 
			...
			exports.striano_map:blipInteresse(vector3(pp.x, pp.y, pp.z))
			PlaySoundFrontend(-1,'Bomb_Disarmed','GTAO_Speed_Convoy_Soundset',0)
			ExecuteCommand("prova3 Waypoint added.")
		end, false) 
	end
...
function ActiveAWayPoint(id)
	exports.striano_map:remove(id) -- Change this with your own waypoint system or download mine from fivem portal -> striano_map
end
...
exports('delblipInteresse', function() 
	for k, v in pairs(myWaypoints) do
		exports.striano_map:remove(v.idway)
...
exports('isopen', function() return camActive end)
exports('blipInteresse', function(pos, colore)
	...
	for k = #myWaypoints, 1, -1 do
		...
		if #(pos - waypointPos) < 9.5 then
			...
			exports.striano_map:remove(waypoint.idway)
	...
	if #myWaypoints >= 5 then
		...
		lastPosToTurn = pos
		exports.striano_map:update(myWaypoints[1].idway, { coords = pos })
		loopWayPoint()
		return
	end
...
RegisterCommand("tpm", function(source)
	...
	if exports.striano_map:isopen() then print("CLOSE THE MAP FOR USE TPM!") return end
	DeActiveStrianoCam()
    TeleportToWaypoint()
end)
